...
import com.example.goweather.widgets.*
...
fun MainScreen(navController: NavController,
    ...
    val weatherData = produceState<DataOrException<Weather, Boolean, Exception>>(
        ...
        value = mainViewModel.getWeatherData(longitude = "110.370529", latitude = "-7.797068")
    }.value
...
fun MainScaffold(weather: Weather, navController: NavController){
    Scaffold(
        topBar = { WeatherAppBar(
            ...
            elevation = 5.dp){
            Log.d("Click", "MainScaffold: ButtonClicked")
        }
        }) {
    ...
    Column(
        ...
        Surface(modifier = Modifier
            ...
            Column(verticalArrangement = Arrangement.Center,
                ...
                Text(text = formatDecimals(weatherItem.main.temp) + "º", style = MaterialTheme.typography.h4,
